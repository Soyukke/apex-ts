...
mod tests {
    ...
    fn test_convert_primitive_types() {
        assert_eq!(
            TypeScriptGenerator::convert_apex_type_to_ts("String"),
            "string"
        );
        assert_eq!(
            TypeScriptGenerator::convert_apex_type_to_ts("Integer"),
            "number"
        );
        assert_eq!(
            TypeScriptGenerator::convert_apex_type_to_ts("Boolean"),
            "boolean"
        );
    }
    ...
    fn test_convert_list_type() {
        assert_eq!(
            TypeScriptGenerator::convert_apex_type_to_ts("List<String>"),
            "string[]"
        );
        assert_eq!(
            TypeScriptGenerator::convert_apex_type_to_ts("List<Integer>"),
            "number[]"
        );
    }
